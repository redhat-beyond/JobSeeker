...
def profile_1(db, user_1):
    profile_1 = PersonalProfile(company = 'Test Company', user = user_1, about = 'Test About',
                                ...
                                resume= SimpleUploadedFile('test_resume.txt', b'these are the contents of the txt file'))
    return profile_1
...
class TestProfileModel:
    ...
    def test_newprofile(self, profile_1, user_1):
        ...
        assert profile_1.profile_pic != None
        assert profile_1.resume != None